...
class StringsTest(unittest.TestCase):
    ...
    def test_contains_with_matching_patterns(self):
        ...
        assert contains('daddaad', 'dad') is True
        assert contains('momm', 'mom') is True
        assert contains('sund', 'd') is True
        assert contains('hahahaha', 'ha') is True
    ...
    def test_contains_with_complex_patterns(self):
        ...
        assert contains('mississippi', 'is') is True
        assert contains('kansas', 'as') is True
